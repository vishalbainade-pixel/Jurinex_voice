...
async def calendar_book(
    ...
    *,
    ...
    if payload.attendee_phone:
        description_lines.append(f"Phone: {payload.attendee_phone}")
    if call_id:
        description_lines.append(f"Originating call_id: {call_id}")
    ...
    try:
        ...
        try:
            ...
            pass
        return {"success": False, "message": f"calendar API error (insert): {exc}"}
